...
```javascript
import isObjectLike from 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-object-like@v0.1.0-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { isObjectLikeArray } from 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-object-like@v0.1.0-deno/mod.js';
```
